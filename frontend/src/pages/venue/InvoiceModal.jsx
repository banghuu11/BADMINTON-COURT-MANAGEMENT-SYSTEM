...
const InvoiceModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#0b1c30]/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl p-6 md:p-8 w-full max-w-2xl shadow-2xl animate-fade-in">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-slate-900">Chi Tiết Hóa Đơn</h2>
          <button
            onClick={onClose}
        ...
        <p className="text-slate-500 mb-4">
          Giao diện hóa đơn sẽ hiển thị ở đây.
        </p>
