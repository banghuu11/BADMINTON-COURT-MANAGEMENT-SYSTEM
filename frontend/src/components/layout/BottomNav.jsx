...
const BottomNav = () => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 bg-white/90 dark:bg-[#00272C]/90 backdrop-blur-xl border-t border-slate-200 dark:border-white/10 flex justify-around items-center px-4 pb-8 pt-3 shadow-[0_-10px_30px_rgba(0,0,0,0.15)] dark:shadow-[0_-10px_30px_rgba(0,0,0,0.5)] transition-colors">
      {navItems.map((item) => {
          ...
          <Link
            ...
            className={`flex flex-col items-center justify-center transition-all duration-200 active:scale-90 ${
              isActive
                ...
                : "text-slate-500 dark:text-slate-400 hover:text-primary px-4 py-1"
            }`}
          >
