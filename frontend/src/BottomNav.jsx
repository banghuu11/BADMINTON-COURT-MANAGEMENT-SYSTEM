...
const BottomNav = () => {
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 bg-[#0b1c30]/80 backdrop-blur-lg border-t border-white/10 flex justify-around items-center px-4 pb-8 pt-3 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
